...
if __name__ == '__main__':
    folder_path = './out/pictureshow/R140'
    ...
    ckpt_path = '/data/40/ntmj/ntmj/eventMain/out/qz/model/139.pth'
            ...
            for i, (gt_image,input_Img, idx,events_forward,events_backward )in enumerate(loader):
                ...
                for j1 in range(crop_count_x):
                    for j2 in range(crop_count_y):
                        ...
                        # 输入图像到模型
                        with torch.no_grad():
                            S, I = model(events_forward_cropped, events_backward_cropped, cropped_image,
                        ...
                        if j1 == 0:
                            if j2 == 0:
                                ...
                                r[0:192, 832:1024] = I[0:192, 64:256]
                            else:
                                r[0:192, j2 * 128 + 64:(j2 + 1) * 128 + 64] = I[0:192, 64:192]
                        elif j1 == num - 1:
                            if j2 == 0:
                                r[832:1024, 0:192] = I[64:256, 0:192]
                            elif j2 == num - 1:
                                r[832:1024, 832:1024] = I[64:256, 64:256]
                            else:
                                r[832:1024, j2 * 128 + 64:(j2 + 1) * 128 + 64] = I[64:256, 64:192]
                        else:
                            if j2 == 0:
                                r[j1 * 128 + 64:(j1 + 1) * 128 + 64, 0:192] = I[64:192, 0:192]
                            elif j2 == num - 1:
                                r[j1 * 128 + 64:(j1 + 1) * 128 + 64, 832:1024] = I[64:192, 64:256]
                            else:
